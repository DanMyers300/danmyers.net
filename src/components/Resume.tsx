    ...
    <>
      <div className="flex flex-col items-center mt-13 min-h-screen">
        ...
        <a
          href="/resume.pdf"
          download
          className="mt-10 bg-gradient-to-r from-purple-600 to-violet-600 text-white px-6 py-3 rounded-lg shadow-lg hover:shadow-xl hover:from-purple-700 hover:to-violet-700 transition duration-200 inline-block"
        >
          Download Resume
        </a>
