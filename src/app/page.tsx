  ...
  return (
    <main className={styles.main}>
      ...
      <div className={styles.aboutMe}> 
        <p>
          I'm Daniel Myers, a machine learning engineer and developer based in Dallas, TX. I specialize in creating innovative solutions and seamless user experiences.
        </p>
        <p>
Currently, I work as a Machine Learning Engineer at FW Gasket, where I develop custom natural language processing solutions. Previously, I worked as a Developer at Musework, collaborating on cloud solutions and creating educational websites.
        </p>
        <p>
